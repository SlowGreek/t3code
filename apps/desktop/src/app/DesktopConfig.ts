...
export const DesktopConfig = Config.all({
  ...
  // Workplace builds cannot be configured into a network-exposed or OTLP-exporting mode.
  desktopLanHostOverride: Config.succeed(Option.none<string>()),
  desktopHttpsEndpointUrls: Config.succeed<ReadonlyArray<string>>([]),
  otlpTracesUrl: Config.succeed(Option.none<string>()),
